...
function Guide:Initialize()
	function Guide:Load()DugisGuideViewer:RegisterGuide("|cfff0c502Leveling|r", "Blacksmithing 1-525", nil, "Alliance", "P", "|SG|DugisGuideViewer.SuggestProfessionGuidePredicate([[Blacksmithing]], nil, 600) and UnitLevel([[player]])>=85|", function()
return [[
...
N Materials List 1-75 |BL| |N|80x [Rough Stone], 150x [Copper Bar]| |P|Blacksmithing 75|
N 1-25 [Rough Sharpening Stone] |BL| |N|30x [Rough Stone].| |P|Blacksmithing 25|
N 25-50 [Rough Grinding Stone] |BL| |N|50x [Rough Stone]. Save 10 for later.| |P|Blacksmithing 50|
...
N Materials List 75-150 |N|100x [Copper Bar], 52x [Coarse Stone], 245x [Bronze Bar], 105x [Heavy Stone]| |P|Blacksmithing 150|
...
N Train Expert Blacksmithing |N|Therum Deepforge (63.7, 37.0), in Stormwind City.| |Z|301| |PM|Blacksmithing|225| |NPC|5511|

N Materials List 150-200 |N|5x [Gold Bar], 35x [Green Dye], 105x [Heavy Stone], 230x [Iron Bar], 50x [Steel Bar]| |P|Blacksmithing 200|
B [Green Dye] |N|You will need 1x [Green Dye] for the next two items. Buy at least 40.| |P|Blacksmithing 195|
...
N Train Artisan Blacksmithing |N|Therum Deepforge (63.7, 37.0), in Stormwind City.| |Z|301| |PM|Blacksmithing|300| |NPC|5511|

N Materials List 200-300 |N|30x [Heavy Stone], 25x [Steel Bar], 350x [Mithril Bar], 40x [Dense Stone], 170x [Mageweave Cloth], 432x [Thorium Bar], 5x [Star Ruby]| |P|Blacksmithing 300|
...
N Materials List 300-350 |BL| |N|165x [Fel Iron Bar], 85x [Adamantite Bar]| |P|Blacksmithing 350|
...
N Materials List 350-425 |BL| |N|320x [Cobalt Bar], 230x [Saronite Bar], 5x [Titanium Bar]| |P|Blacksmithing 425|
...
N Materials List 425-500 |BL| |N|266x [Obsidium Bar], 132x [Elementium Bar], 10x [Volatile Earth]| |P|Blacksmithing 500|
...
N Materials List 500-600 |BL| |N|165x [Ghost Iron Bar], 4x [Spirit of Harmony]| |P|Blacksmithing 575|
