...
function Guide:Initialize()
	function Guide:Load()DugisGuideViewer:RegisterGuide("|cfff0c502Leveling|r", "Enchanting 1-600", nil, "Alliance", "P", "|SG|DugisGuideViewer.SuggestProfessionGuidePredicate([[Enchanting]], nil, 600) and UnitLevel([[player]])>=90|", function()
return [[
...
N Train Apprentice Enchanting |N|Lucan Cordell (53.0, 74.3).| |Z|301| |PM|Enchanting|75| |NPC|1317|
B [Copper Rod] |N|Jessara Cordell (53.0, 74.3) <Enchanting Supplies>.| |Z|301| |L|6217| |P|Enchanting 2| |NPC|1318|
...
N Train Journeyman Enchanting |N|Lucan Cordell (53.0, 74.3).| |Z|301| |PM|Enchanting|150| |NPC|1317|
...
B [Enchant Cloak - Minor Agility] |N|Dalria (35.1, 52.1)| |Z|43| |P|Enchanting 130| |NPC|3954|
B [Enchant Bracer - Lesser Strength] |N|Dalria (35.1, 52.1)| |Z|43| |P|Enchanting 165| |NPC|3954|
...
N Train Expert Enchanting |N|Lucan Cordell (53.0, 74.3).| |Z|301| |PM|Enchanting|225| |NPC|1317|
...
N Train Artisan Enchanting |N|Lucan Cordell (53.0, 74.3).| |Z|301| |PM|Enchanting|300| |NPC|1317|
...
B [Enchant Shield - Greater Stamina] |N|Mythrin'dir (58.0, 34.2). This is a BoP recipe.| |Z|381| |L|16217| |P|Enchanting 285| |NPC|4229|

N Train New Recipes.. |N|as needed from Taladan (56.6, 31.1). Tick this step.| |Z|381| |P|Enchanting 300| |NPC|4213|
...
N Train Master Enchanting |N|Taladan (56.6, 31.1).| |Z|381| |PM|Enchanting|375| |NPC|4213|
...
N Train Grand Master Enchanting |N|Lucan Cordell (53.0, 74.3).| |Z|301| |PM|Enchanting|425| |NPC|1317|
...
N Train Illustrious Grand Master Enchanting |N|Lucan Cordell (53.0, 74.3).| |Z|301| |PM|Enchanting|525| |NPC|1317|
...
N Train Zen Master Enchanting |N|Lucan Cordell (53.0, 74.3).| |Z|301| |PM|Enchanting|600| |NPC|1317|
