...
function Guide:Initialize()
	function Guide:Load()DugisGuideViewer:RegisterGuide("|cfff0c502Leveling|r", "Inscription 1-600", nil, "Alliance", "P", "|SG|DugisGuideViewer.SuggestProfessionGuidePredicate([[Inscription]], nil, 600) and UnitLevel([[player]])>=90|", function()
return [[
...
B [Virtuoso Inking Set] |N|Stanly McCormick <Inscription Supplies> (49.8, 74.1)| |L|39505| |Z|301| |P|Inscription 1| |NPC|30730|
...
N 255-260 Scroll of Spirit V |N|5x [Shimmering Ink], 10x [Light Parchment]| |P|Inscription 260|
...
N Train Illustrious Grand Master Inscription |N|Catarina Stanford (49.8, 74.1).| |Z|301| |PM|Inscription|525| |NPC|30713|
...
N Train Zen Master Inscription |N|Catarina Stanford (49.8, 74.1).| |Z|301| |PM|Inscription|600| |NPC|30713|
