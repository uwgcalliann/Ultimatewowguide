...
function Guide:Initialize()
	function Guide:Load()DugisGuideViewer:RegisterGuide("|cfff0c502Leveling|r", "Cooking 1-525", nil, "Alliance", "P", nil, function()
return [[
...
N Note! |N|The trainers listed are the ones in Stormwind City. Obviously you can use others as you see fit. If you are in a city or village, a lot of times the fires that they have burning will suffice for cooking your meat, otherwise use your start fire skill to build a cooking fire.| |P|Cooking 2|
...
N Materials List 1-75 |N|40x [Simple Flour], 40x [Mild Spice], 15x [Stringy Wolf Meat], 25x [Bear Meat] or 25x [Kodo Meat]| |P|Cooking 75|
...
N 50-75 [Smoked Bear Meat] or [Roasted Kodo Meat] |CO| |N|25x [Bear Meat] or 25x [Kodo Meat].| |P|Cooking 75|
...
N 75-105 [Boiled Clams] |CO| |N|30x [Clam Meat], 30x [Refreshing Spring Water].| |P|Cooking 105|
N 105-130 [Crab Cake] |CO| |N|25x [Crawler Meat].| |P|Cooking 130|
