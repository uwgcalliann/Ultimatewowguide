...
function Guide:Initialize()
	function Guide:Load()DugisGuideViewer:RegisterGuide("|cfff0c502Leveling With Farming|r", "Blacksmithing w/Farming 1-600", nil, "Alliance", "P", "|SG|DugisGuideViewer.SuggestProfessionGuidePredicate([[Blacksmithing]], nil, 600, [[Mining]])|", function()
return [[
...
N Train Apprentice Blacksmithing |N|Therum Deepforge (63.7, 37.0), in Stormwind City| |Z|301| |PM|Blacksmithing|75| |NPC|5511|
B [Blacksmith Hammer] |N|Buy from Kaita Deepforge (63.3, 37.7), in Stormwind City.| |L|5956| |Z|301| |P|Blacksmithing 51| |NPC|5512|

R Elwynn Forest |N|Travel to Elwynn Forest (34.3, 52.6)| |P|Blacksmithing 75| |Z|30|
N Farm Elwynn Forest |MI| |LOOP| |N|Farm 120x [Rough Stone], 373x [Copper Ore] (30.8, 56.5)(28.6, 63.1)(26.9, 69.5)(20.9, 72.8)(23.7, 83.4)(37.4, 71.4)(39.3, 81.7)(49.6, 85.6)(60.4, 76.6)(69.1, 69.3)(74.0, 50.2)(81.8, 55.7)(79.4, 38.8)(65.2, 38.0)(62.1, 53.0)(50.0, 60.7)(43.5, 49.3)(38.6, 51.4)| |L|2835 120| |Z|30| |P|Blacksmithing 75| |OBJ|310|
N Farm Elwynn Forest |MI| |LOOP| |N|Farm 120x [Rough Stone], 373x [Copper Ore] (30.8, 56.5)(28.6, 63.1)(26.9, 69.5)(20.9, 72.8)(23.7, 83.4)(37.4, 71.4)(39.3, 81.7)(49.6, 85.6)(60.4, 76.6)(69.1, 69.3)(74.0, 50.2)(81.8, 55.7)(79.4, 38.8)(65.2, 38.0)(62.1, 53.0)(50.0, 60.7)(43.5, 49.3)(38.6, 51.4)| |L|2770 373| |Z|30| |P|Blacksmithing 75| |OBJ|310|

R Stormwind City |N|Travel to Stormwind City (63, 71)| |Z|301| |P|Blacksmithing 75|
N Smelt Ore |SM| |N|Go to a forge (63.7, 37.0) and smelt all the [Copper Ore] into bars. Tick this step.| |Z|301| |P|Blacksmithing 100|
N Train New Recipes.. |N|as needed from Therum Deepforge (63.7, 37.0), in Stormwind City Tick this step.| |Z|301| |P|Blacksmithing 75| |NPC|5511|
...
N Train Journeyman Blacksmithing |N|Therum Deepforge (63.7, 37.0), in Stormwind City| |Z|301| |PM|Blacksmithing|150| |NPC|5511|
...
N Smelt Ore |SM| |N|Go to a forge (63.7, 37.0) and smelt all the [Truesilver Ore] into bars. Tick this step.| |Z|301| |P|Blacksmithing 235|
N Smelt Ore |SM| |N|Go to a forge (63.7, 37.0) and smelt all the [Mithril Ore] into bars. Tick this step.| |Z|301| |P|Blacksmithing 250|
N Smelt Ore |SM| |N|Go to a forge (63.7, 37.0) and smelt all the [Thorium Ore] into bars. Tick this step.| |Z|301| |P|Blacksmithing 300|

N Train New Recipes.. |N|as needed from Therum Deepforge (63.7, 37.0), in Stormwind City Tick this step.| |Z|301| |P|Blacksmithing 300| |NPC|5511|
...
N Train Master Blacksmithing |N|Therum Deepforge (63.7, 37.0), in Stormwind City| |Z|301| |PM|Blacksmithing|375| |NPC|5511|
...
N Smelt Ore |SM| |N|Go to a forge (56.8, 63.8) and smelt all the [Fel Iron Ore] into bars. Tick this step.| |Z|465| |P|Blacksmithing 335|

N Train New Recipes.. |N|as needed from Humphry (56.8, 63.8), in Honor Hold.| |Z|465| |P|Blacksmithing 325| |NPC|16823|
...
B [Plans: Lesser Ward of Shielding] |N|Mari Stonehand (36.8, 55.1)| |Z|473| |P|Blacksmithing 350| |NPC|19373|
N 340-350 [Lesser Ward of Shielding] |N|30x [Adamantite Bar].| |P|Blacksmithing 350|

R Stormwind City |N|Travel to Stormwind City (55.6, 85.9)| |Z|301| |P|Blacksmithing 425|

N Train Grand Master Blacksmithing |N|Therum Deepforge (63.7, 37.0), in Stormwind City| |Z|301| |PM|Blacksmithing|450| |NPC|5511|
...
N Smelt Ore |SM| |N|Go to a forge (63.7, 37.0) and smelt all the [Cobalt Ore] into bars. Tick this step.| |Z|301| |P|Blacksmithing 405|
N Smelt Ore |SM| |N|Go to a forge (63.7, 37.0) and smelt all the [Saronite Ore] into bars. Tick this step.| |Z|301| |P|Blacksmithing 425|

N Train New Recipes.. |N|as needed from Therum Deepforge (63.7, 37.0), in Stormwind City| |Z|301| |P|Blacksmithing 425| |NPC|5511|
...
N Train Illustrious Grand Master Blacksmithing |N|Therum Deepforge (63.7, 37.0), in Stormwind City| |Z|301| |PM|Blacksmithing|525| |NPC|5511|
...
N Smelt Ore |SM| |N|Go to a forge (76.4, 34.6) and smelt all the [Obsidium Ore] into bars. Tick this step.| |Z|301| |P|Blacksmithing 500|

N Train New Recipes.. |N|as needed from Therum Deepforge (63.7, 37.0), in Stormwind City| |Z|301| |P|Blacksmithing 475| |NPC|5511|
...
N Smelt Ore |SM| |N|Go to a forge (63.7, 37.0) and smelt all the [Elementium Ore] into bars. Tick this step.| |Z|301| |P|Blacksmithing 525|

N Train New Recipes.. |N|as needed from Therum Deepforge (63.7, 37.0), in Stormwind City| |Z|301| |P|Blacksmithing 512| |NPC|5511|
