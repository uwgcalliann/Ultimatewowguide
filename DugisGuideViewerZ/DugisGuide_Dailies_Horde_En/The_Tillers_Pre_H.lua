...
function Guide:Initialize()
	function Guide:Load()DugisGuideViewer:RegisterGuide("|cfff0c502Pandaria|r", "The Tillers (Pre-Quest)", nil, "Horde", "D", "|SG|UnitLevel([[player]])>=90 and not DugisGuideViewer.SuggestQuestAchievementPredicate(30257) and DugisGuideViewer.SuggestReputationAchievementPredicate(1272)|", function()
return [[
