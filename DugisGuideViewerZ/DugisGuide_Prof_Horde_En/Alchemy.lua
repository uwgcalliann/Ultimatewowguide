...
function Guide:Initialize()
	function Guide:Load()DugisGuideViewer:RegisterGuide("|cfff0c502Leveling|r", "Alchemy 1-600", nil, "Horde", "P", "|SG|DugisGuideViewer.SuggestProfessionGuidePredicate([[Alchemy]], nil, 600) and UnitLevel([[player]])>=90|", function()
return [[
...
N Train Apprentice Alchemy |N|Yelmak (55.6, 45.8), in Orgrimmar.| |Z|321| |PM|Alchemy|75| |NPC|3347|
...
N Materials List 60-150 |N|101x [Briarthorn], 30x [Mageroyal], 31x [Bruiseweed], 10x [Stranglekelp], 61x [Crystal Vial]| |P|Alchemy 150|
...
N 110-140 [Healing Potion] |AL| |N|31x [Bruiseweed], 31x [Briarthorn], 31x [Crystal Vial].| |P|Alchemy 140|
...
N Train Expert Alchemy |N|Yelmak (55.6, 45.8), in Orgrimmar.| |Z|321| |PM|Alchemy|225| |NPC|3347|
...
N Train Artisan Alchemy |N|Yelmak (55.6, 45.8), in Orgrimmar.| |Z|321| |PM|Alchemy|300| |NPC|3347|
