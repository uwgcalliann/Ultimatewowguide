...
function Guide:Initialize()
	function Guide:Load()DugisGuideViewer:RegisterGuide("|cfff0c502Leveling With Farming|r", "Engineering w/Farming 1-600", nil, "Horde", "P", "|SG|DugisGuideViewer.SuggestProfessionGuidePredicate([[Engineering]], nil, 600, [[Mining]])|", function()
return [[
...
N Train Apprentice Engineering |N|Roxxik (56.9, 56.5)| |Z|321| |PM|Engineering|75| |NPC|11017|
B [Blacksmith Hammer] |N|Sovik (56.9, 56.5)| |L|5956| |Z|321| |P|Engineering 31| |NPC|3413|
B 2x [Wooden Stock] |N|Sovik (56.9, 56.5)| |L|4399 2| |Z|321| |P|Engineering 75| |NPC|3413|
...
N Farm Durotar |MI| |LOOP| |N|Farm 20x [Rough Stone], 160x [Copper Ore] (38.9, 15.5)(37.6, 20.9)(36.0, 34.1)(36.7, 51.7)(44.2, 49.6)(50.6, 47.2)(50.5, 63.1)(55.2, 66.9)(56.0, 49.1)(54.9, 37.1)(53.1, 29.1)(54.6, 18.8)(49.9, 17.7)(43.7, 24.0)| |L|2835 20| |Z|4| |P|Engineering 51| |OBJ|310|
N Farm Durotar |MI| |LOOP| |N|Farm 20x [Rough Stone], 160x [Copper Ore] (38.9, 15.5)(37.6, 20.9)(36.0, 34.1)(36.7, 51.7)(44.2, 49.6)(50.6, 47.2)(50.5, 63.1)(55.2, 66.9)(56.0, 49.1)(54.9, 37.1)(53.1, 29.1)(54.6, 18.8)(49.9, 17.7)(43.7, 24.0)| |L|2770 160| |Z|4| |P|Engineering 51| |OBJ|310|
N Farm [Linen Cloth] |ENG| |N|Kill Northwatch mobs (59, 56) or Razormane mobs (47, 49) for 30x [Linen Cloth]| |L|2589 30| |Z|4| |P|Engineering 95| |NPC|39267, 39268, 3111, 3112|

R Orgrimmar |N|Travel to Orgrimmar (45, 06)| |Z|321| |P|Engineering 51|
N Smelt Ore |SM| |N|Go to a forge (44.8, 77.3) and smelt all the [Copper Ore] into bars. Tick this step.| |Z|321| |P|Engineering 100|

N Train New Recipes.. |N|as needed from Roxxik (56.9, 56.5), in Orgrimmar. Tick this step.| |Z|321| |P|Engineering 75| |NPC|11017|
...
N Train Journeyman Engineering |N|Roxxik (56.9, 56.5).| |Z|321| |PM|Engineering|150| |NPC|11017|
...
B 4x[Coal] |N|Punra <Blacksmithing Supplies> (45.0, 77.6)| |L|3857 4| |Z|321| |P|Engineering 176| |NPC|46359|
N Smelt Ore |SM| |N|Go to a forge (44.8, 77.3) and smelt all the [Tin Ore] into bars. Tick this step.| |Z|321| |P|Engineering 160|
N Create 138x [Bronze Bar] |SM| |N|69x [Copper Bar], 69x [Tin Bar], Use the forge (44.8, 77.3).| |L|2841 138| |Z|321| |P|Engineering 150|
N Smelt Ore |SM| |N|Go to a forge (44.8, 77.3) and smelt all the [Iron Ore] into bars. Tick this step.| |Z|321| |P|Engineering 176|
N Smelt Ore |SM| |N|Go to a forge (44.8, 77.3) and smelt all the [Gold Ore] into bars. Tick this step.| |Z|321| |P|Engineering 175|
N Smelt Steel |SM| |N|Go to a forge (44.8, 77.3) and smelt [Steel Bar]. Tick this step.| |L|3859 4| |Z|321| |P|Engineering 176|
...
N Train New Recipes.. |N|as needed from Roxxik (56.9, 56.5), in Orgrimmar. Tick this step.| |Z|321| |P|Engineering 200| |NPC|11017|
...
N Train Expert Engineering |N|Roxxik (56.9, 56.5).| |Z|321| |PM|Engineering|225| |NPC|11017|
...
K Farm 50x [Mageweave Cloth] [ENG] |N|Kill Jaedenar (39, 57), Jadefire (38, 67), and/or Deadwood (49, 86) Mobs for 50x [Mageweave Cloth]| |L|4338 50| |Z|182| |P|Engineering 250|
...
N Smelt Ore |SM| |N|Go to a forge (44.8, 77.3) and smelt all the [Mithril Ore] into bars. Tick this step.| |Z|321| |P|Engineering 250|
N Smelt Ore |SM| |N|Go to a forge (44.8, 77.3) and smelt all the [Thorium Ore] into bars. Tick this step.| |Z|321| |P|Engineering 300|
...
N Train New Recipes.. |N|as needed from Roxxik (56.9, 56.5), in Orgrimmar. Tick this step.| |Z|321| |P|Engineering 300| |NPC|11017|
...
N Train Artisan Engineering |N|Roxxik (56.9, 56.5).| |Z|321| |PM|Engineering|300| |NPC|11017|
...
N Train Master Engineering |N|Roxxik (56.9, 56.5).| |Z|321| |PM|Engineering|375| |NPC|11017|
B 5x [Heavy Stock] |N|Sovik (56.9, 56.5)| |L|4400 5| |Z|321| |P|Engineering 325| |NPC|3413|
...
N Smelt Ore |SM| |N|Go to a forge (53.2, 28.2) and smelt all the [Fel Iron Ore] into bars. Tick this step.| |Z|465| |P|Engineering 350|

N Train New Recipes.. |N|as needed from Zebig (54.8, 38.5), in Thrallmar. Tick this step.| |Z|465| |P|Engineering 350| |NPC|18752|
...
N Smelt Ore |SM| |N|Go to a forge (44.8, 77.3) and smelt all the [Adamantite Ore] into bars. Tick this step.| |Z|321| |P|Engineering 350|

N Train New Recipes.. |N|as needed from Roxxik (56.9, 56.5), in Orgrimmar. Tick this step.| |Z|321| |P|Engineering 350| |NPC|11017|
...
N Train Grand Master Engineering |N|Roxxik (56.9, 56.5).| |Z|321| |PM|Engineering|450| |NPC|11017|

R Zul'Drak |N|Travel to Zul'Drak (12.6, 68.3)| |P|Engineering 425| |Z|496|

N Farm Zul'Drak |MI| |LOOP| |N|Farm 325x [Cobalt Ore], 10x [Crystallized Earth], keep all [Crystallized Water] (12.6, 68.3)(09.5, 75.9)(12.5, 85.8)(21.7, 70.4)(34.1, 66.0)(43.6, 83.1)(58.9, 76.5)(48.5, 66.9)(59.8, 58.4)(72.6, 47.3)(71.7, 31.4)(54.2, 47.3)(53.4, 32.6)(40.2, 40.5)(33.2, 40.9)(33.8, 61.1)| |L|37701 10| |Z|496| |P|Engineering 425| |OBJ|7881|
N Farm Zul'Drak |MI| |LOOP| |N|Farm 325x [Cobalt Ore], 10x [Crystallized Earth], keep all [Crystallized Water] (12.6, 68.3)(09.5, 75.9)(12.5, 85.8)(21.7, 70.4)(34.1, 66.0)(43.6, 83.1)(58.9, 76.5)(48.5, 66.9)(59.8, 58.4)(72.6, 47.3)(71.7, 31.4)(54.2, 47.3)(53.4, 32.6)(40.2, 40.5)(33.2, 40.9)(33.8, 61.1)| |L|36909 325| |Z|496| |P|Engineering 425| |OBJ|7881|
...
N Smelt Ore |SM| |N|Go to a forge (44.8, 77.3) and smelt all the [Cobalt Ore] into bars. Tick this step.| |Z|321| |P|Engineering 425|
N Smelt Ore |SM| |N|Go to a forge (44.8, 77.3) and smelt all the [Saronite Ore] into bars. Tick this step.| |Z|321| |P|Engineering 425|
B 10x [Frostweave Cloth] |N|Buy 10x [Frostweave Cloth] from Auction House or Trade chat.| |L|33470 10| |P|Engineering 425|

N Train New Recipes.. |N|as needed from Roxxik (56.9, 56.5), in Orgrimmar. Tick this step.| |Z|321| |P|Engineering 425| |NPC|11017|
...
N Train Illustrious Grand Master Engineering |N|Roxxik (56.9, 56.5).| |Z|321| |PM|Engineering|525| |NPC|11017|
...
N Train New Recipes.. |N|as needed from Roxxik (56.9, 56.5), in Orgrimmar. Tick this step.| |Z|321| |P|Engineering 450| |NPC|11017|
...
N Smelt Ore |SM| |N|Go to a forge (44.8, 77.3) and smelt all the [Elementium Ore] into bars. Tick this step.| |Z|321| |P|Engineering 500|
N [Hardened Elementium Bar] |SM| |N|Go to a forge (44.8, 77.3) and create 5x [Hardened Elementium Bar]. Tick this step.| |Z|321| |P|Engineering 500|

N Train New Recipes.. |N|as needed from Roxxik (56.9, 56.5), in Orgrimmar. Tick this step.| |Z|321| |P|Engineering 500| |NPC|11017|
