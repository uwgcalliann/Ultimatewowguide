...
function Guide:Initialize()
	function Guide:Load()DugisGuideViewer:RegisterGuide("|cfff0c502Leveling|r", "Engineering 1-600", nil, "Horde", "P", "|SG|DugisGuideViewer.SuggestProfessionGuidePredicate([[Engineering]], nil, 600) and UnitLevel([[player]])>=90|", function()
return [[
...
B [Blacksmith Hammer] [ENG] |N|Sovik <Engineering Supplies> (56.9, 56.5).| |Z|321| |L|5956| |P|Engineering 31| |NPC|3413|
...
N Train Zen Master Engineering |N|Roxxik (56.9, 56.5).| |Z|321| |PM|Engineering|600| |NPC|11017|
