...
function Guide:Initialize()
	function Guide:Load()DugisGuideViewer:RegisterGuide("|cfff0c502Cataclysm|r ", "757(85)", nil, "Alliance", "I", nil, function()
return [[
...
C Soften them Up |N|Free a Red Drake (29.4, 24.2) a within Grim Batol and use it to destroy 30 Troggs and 15 Twilight's Hammer minions| |QID|28852| |NPC|39294|
