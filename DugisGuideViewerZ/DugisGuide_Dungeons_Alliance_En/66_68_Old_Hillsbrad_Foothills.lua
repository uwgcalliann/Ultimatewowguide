...
function Guide:Initialize()
	function Guide:Load()DugisGuideViewer:RegisterGuide("|cfff0c502Outland|r ", "734(66-68)", "710(66-70)", "Alliance", "I", nil, function()
return [[

R Tanaris |N|Travel to Tanaris, you can talk to Zephyr at the World's End Tavern in Shattrath to teleport to Tanaris (74.67, 31.45)| |Z|481| |NPC|25967|
...
R Caverns of Time |N|Travel to Caverns of Time (65.35, 49.72)| |Z|161| |QID|10279| |O|
