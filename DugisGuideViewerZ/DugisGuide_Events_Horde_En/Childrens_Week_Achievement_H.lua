...
function Guide:Initialize()
	function Guide:Load()DugisGuideViewer:RegisterGuide("|cfff0c502Children's Week|r ", "Children's Week (80+ Achievement)", nil, "Horde", "E", "|SG|DugisGuideViewer.SuggestCurrentHolidayPredicate([[Calendar_ChildrensWeek]])|", function()
return [[

R Orgrimmar |N|Travel to Orgrimmar (70.9, 25.6)| |Z|321|
N [Orcish Orphan Whistle] |T| |N|Collect 1 [Orcish Orphan Whistle] from Orphan Matron Battlewail (70.9, 25.6)| |L|18597| |Z|321| |NPC|14451|
...
B [Tasty Cupcake] |N|Purchase the follow items from the Auction House, or use your Cooking ability to create them| |L|43490| |AID|1788| |Z|321|
B [Delicious Chocolate Cake] |N|Purchase the follow items from the Auction House, or use your Cooking ability to create them| |L|33924| |AID|1788| |Z|321|
...
U [Orcish Orphan Whistle] |T| |N|Use [Orcish Orphan Whistle] make sure your orphan is standing next to you before you begin eating| |U|18597|
...
N Eat [Lovely Cake Slice] |AID|1788| |AC|5| |N|Use [Lovely Cake Slice]| |U|42434|
