...
function Guide:Initialize()
	function Guide:Load()DugisGuideViewer:RegisterGuide("|cfff0c502Outland|r ", "726(63-65)", "732(64-66)", "Horde", "I", nil, function()
return [[

R Underbog |N|Queue for Underbog with your Dungeon Finder or enter from Coilfang Reservoir in Zangarmarsh. You need to swim down and through the Reservoir to reach the entrance (54.22, 34.41)| |QID|9717| |I| |Z|467| |WR| |F|726 1|
...
N Guide Complete. Continue To Mana-Tombs (64-66) |N|Tick to continue to Mana-Tombs (64-66) - UltimateWoWGuide.com| 
