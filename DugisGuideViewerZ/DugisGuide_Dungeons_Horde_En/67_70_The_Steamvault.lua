...
function Guide:Initialize()
	function Guide:Load()DugisGuideViewer:RegisterGuide("|cfff0c502Outland|r ", "727(67-70)", "523(68-70)", "Horde", "I", nil, function()
return [[

R The Steamvault |N|Use your dungeon finder to queue for Steamvault or enter from Coilfang Reservoir in Zangarmarsh. You need to swim down and through the Resrvoir to reach the entrance(50.34, 33.34)| |I| |QID|29613| |WR| |Z|467| |F|727 1|
...
N Guide Complete. Tick To Continue To Utgarde Keep (68-70) |N|Tick to continue to Utgarde Keep (68-70) - UltimateWoWGuide.com| 
